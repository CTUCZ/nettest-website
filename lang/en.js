...
exports.strings = {
    ...
    "opendata_content" : {
        ...
        "content_block" : 'The results on CTU-NetTest measurement tool are published as open data in compliance with privacy policy. <a href="/en/DataSpecification">The data format specification</a> describes information available as open data in CSV format (see below).',        "csv_interface" : 'Download interface',
