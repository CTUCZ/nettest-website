...
exports.strings = {
    ...
    "template": {
        "ctu": "ČTÚ",
        "vportal_ctu": "Vizualizační portál",
        "vportal_url" : "https://vportal.ctu.gov.cz/",
    ...
    "options_content" : {
        ...
        "email_address": "nettest@ctu.gov.cz",
    },
    ...
    "certified_measurement_content": {
        ...
        "note_vpn": "Pokud používáte VPN, proxy servery nebo jiné služby, které mohou ovlivnit výsledky měření, odpojte se od nich.",
        ...
        "questions_desc": "Dotazy ohledně certifikovaného měření směřujte, prosím, na adresu <a href='mailto:nettest@ctu.gov.cz'> nettest@ctu.gov.cz </a>.",
        ...
        "location_accuracy": "Zobrazeny budou pouze výsledky u kterých byla zaznamenána poloha s přesností do 50 metrů a současně je tato poloha v souladu s vyplněným adresním místem měření.",
        ...
        "provider_adv_speed": "Inzerovaná rychlost",
        "provider_norm_speed": "Běžně dostupná rychlost",
        ...
        "summary_5": "Odpojte se od VPN, proxy serverů a dalších služeb, které mohou ovlivnit výsledky měření!",
